  ...
  return (
    <div className="min-h-screen bg-white flex">
      ...
      <div className="hidden lg:flex lg:w-1/2 relative overflow-hidden bg-gray-900">
        ...
        <img
          src="https://images.unsplash.com/photo-1555529733-0e670560f7e1?q=80&w=1974&auto=format&fit=crop"
        ...
        <div className="absolute top-0 left-0 w-full h-full z-20 overflow-hidden">
          <div className="absolute bottom-1/4 left-10 w-72 h-72 bg-white/10 rounded-full blur-3xl"></div>
          <div className="absolute top-1/3 right-10 w-80 h-80 bg-indigo-500/20 rounded-full blur-3xl"></div>
        </div>
        ...
        <div className="relative z-30 flex flex-col justify-between p-16 w-full text-white">
          ...
          <div className="space-y-6 max-w-lg">
            ...
            <p className="text-lg text-indigo-100/90 leading-relaxed">
              Buat akun baru dan nikmati pengalaman belanja tak terbatas.
              Dapatkan akses ke fitur eksklusif dan promo menarik.
            </p>
          </div>
      ...
      <div className="w-full lg:w-1/2 flex flex-col justify-center items-center p-8 sm:p-12 lg:p-24 bg-gray-50/50">
        <div className="w-full max-w-md space-y-8">
          ...
          <form onSubmit={handleSubmit} className="space-y-5 mt-8">
            ...
            <button
              type="submit"
              className="w-full flex justify-center py-3.5 px-4 border border-transparent rounded-xl shadow-lg shadow-indigo-500/30 text-sm font-semibold text-white bg-gradient-to-r from-indigo-600 to-violet-600 hover:shadow-indigo-500/50 hover:scale-[1.02] active:scale-[0.98] transition-all duration-200 mt-2"
            >
              Buat Akun
            </button>
          </form>
